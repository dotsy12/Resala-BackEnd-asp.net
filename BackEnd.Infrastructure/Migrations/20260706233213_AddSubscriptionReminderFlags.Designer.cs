...
namespace BackEnd.Infrastructure.Migrations
{
    ...
    [Migration("20260706233213_AddSubscriptionReminderFlags")]
    partial class AddSubscriptionReminderFlags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BackEnd.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEOcEYVjgybLqp7nN+gohg4gwgy+q7KoO0fjjYowaSonYe/PDMo0iZoemC5xm2E1FLw==",
            ...
            modelBuilder.Entity("BackEnd.Domain.Entities.Notification.DeviceToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BackEnd.Domain.Entities.Payment.PaymentNumber", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("PaymentNumbers", (string)null);
                });
            ...
            modelBuilder.Entity("BackEnd.Domain.Entities.Sponsorship.SponsorshipSubscription", b =>
                {
                    ...
                    b.Property<int>("PostDueRemindersCount")
                        .HasColumnType("int");

                    b.Property<bool>("Sent100PercentReminder")
                        .HasColumnType("bit");

                    b.Property<bool>("Sent50PercentReminder")
                        .HasColumnType("bit");

                    b.Property<bool>("Sent75PercentReminder")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("BackEnd.Domain.Entities.SupportMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ChatOwnerUserId")
                        .IsRequired()
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BackEnd.Domain.Entities.CartItem", b =>
                {
                    ...
                    b.HasOne("BackEnd.Domain.Entities.EmergencyCase.EmergencyCase", "EmergencyCase")
                        .WithMany()
                    ...
                    b.OwnsOne("BackEnd.Domain.ValueObjects.Money", "DonationAmount", b1 =>
                        {
